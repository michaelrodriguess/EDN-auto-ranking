...
const RankingPageContent: React.FC<{
    ...
    return (
        <main className="flex flex-col min-h-screen bg-gradient-to-r from-blue-500 to-cyan-500">
            ...
            <div className="mt-14 flex flex-col items-center justify-center w-full z-0">
                {participants.length > 0 ? (
                    <section
                        className="relative w-full max-w-fit p-8 mb-20 rounded-lg shadow-lg flex flex-col items-center bg-[#DFDBE5] bg-opacity-90"
                        style={{
                    ...
                    <div className="flex flex-col items-center">
                        <div
                            role="status"
                            className="animate-spin rounded-full h-8 w-8 border-t-4 border-b-4 border-blue-500 mb-4"
